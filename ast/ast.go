...
type ReturnStatement struct {
	Token       token.Token // The token representing the 'return' keyword
	ReturnValue Expression  // The value to be returned
}
...
type IntegerLiteral struct {
	Token token.Token // The token representing the integer literal
...
type PrefixExpression struct {
	Token    token.Token // The token representing the prefix operator
...
type InfixExpression struct {
	Token    token.Token // The token representing the infix operator
